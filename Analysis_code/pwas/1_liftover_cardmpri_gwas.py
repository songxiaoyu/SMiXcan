...
DEFAULT_INPUT_FILE = os.path.join(
    ...
    "Heart",
    "Data",
    "I9_CARDMPRI.gwas.imputed_v3.both_sexes.tsv.bgz",
)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Lift CARDMPRI GWAS variants from GRCh37/hg19 to GRCh38/hg38 and add rsID annotation."
    )
