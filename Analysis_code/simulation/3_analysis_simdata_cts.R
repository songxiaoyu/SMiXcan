...
for (b2 in c(2)){
  ...
  for(i in 1:ITR){
    Data_batch = DataGen_newhap(mc=B, n.train=n_train, n.test=3000, p=50, b0=1, 
                                    nonzero_beta1=1, nonzero_beta2=b2, gammas=eta[t, ], 
                                   var1=1, var2=1,var_D=1, seed=(i+1),group = "heter xy", X_pool=X_pool_filtered,snp_region = 1:50,eta_0 = 0.3)
    filename =  paste0('Data/Data_batch_0408_heter_datagen1_b2_',b2,'_', t,'setting', i,'.Rdata')
    ...
    filename =   paste0('Data/result_batch_0408_heter_datagen1_b2_',b2,'_', t,'setting', i,'.csv')
