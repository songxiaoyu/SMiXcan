...
**SMiXcanK** is a summary-statistics-based, cell-type-aware TWAS framework for studying how genetically predicted expression relates to disease risk across multiple cell types.

This document walks through the basic SMiXcanK workflow using the small example datasets bundled with the package.
...
With R, users can install the SMiXcanK package directly from GitHub with [devtools](https://github.com/hadley/devtools):
